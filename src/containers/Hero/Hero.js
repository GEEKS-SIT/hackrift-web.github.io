...
export default function Hero() {
  return (
    <div className="lg:grid lg:grid-cols-12 lg:gap-8 md:py-12 items-center pb-12 md:pb-0; px-4 md:px-0">
      <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-4 lg:text-left">
        ...
        <p className="mt-3 text-accent font-bold sm:mt-5 text-3xl">
      ...
      <div className="relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-8 lg:flex lg:items-center">
        <div className="relative md:ml-auto w-full lg:max-w-2xl">
          <img src={hero} alt="" />
        </div>
      </div>
    </div>
