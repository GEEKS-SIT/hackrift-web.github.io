      ...
      <nav className="navbar bg-transparent py-4 ">
        ...
        <div className="navbar-center hidden lg:flex" >
          <ul className="menu menu-horizontal  p-0">
            <li>
              <a href="#about" className="btn btn-ghost mr-2">About</a>
            </li>
            <li>
              <a href="#schedule" className="btn btn-ghost mr-2">Schedule</a>
            </li>
            <li>
              <a href="#prizes" className="btn btn-ghost mr-2">Prizes</a>
            </li>
            <li>
              <a href="#sponsors" className="btn btn-ghost mr-2">Sponsors</a>
            </li>
            <li>
